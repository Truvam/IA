...
phrase_preposition(phrase_preposition(Prep, Noun_P)) --> preposition(Prep), noun_phrase(Noun_P).
phrase_preposition(phrase_preposition(Prep, NP_Plural)) --> preposition(Prep), noun_phrase_p(NP_Plural).
...
verbal_phrase(verbal_phrase(Verbal_P, Prep, NP_Plural)) --> verb(Verbal_P), preposition(Prep), noun_phrase_p(NP_Plural).
...
verbal_phrase_p(verbal_phrase_p(VP_Plural, Prep, NP_Plural)) --> verb_p(VP_Plural), preposition(Prep), noun_phrase_p(NP_Plural).  